/*
 * Title:   Conext | Connecting Your Future - Main Javascript
...
sjq(document).ready(function($) {
    ...
    $(".progress-bar").each(function() {
        if ($(this).closest(".progress-bar-container").hasClass("style-vertical")) {
            ...
            $(this).find(".progress-inner").width($(this).find(".progress-inner").data("percent") + "%");
        }
    });
    ...
    function initMediaElementPlayer() {
        if ($.fn.mediaelementplayer) {
            $('.video-container.mejs-skin video').each(function() {
                ...
                obj = $(this),
                videoWidth = stGlobals.isMobile ? max(window.screen.availWidth, window.screen.availHeight, 1000) : window.screen.availWidth,
                ...
                $(this).mediaelementplayer({
                    ...
                    success: function(media, node, player) {
                        ...
                        if (media.pluginType == "flash" || media.pluginType == "youtube") {
            ...
            $('.video-container.mejs-skin').each(function() {
                ...
                if ($(this).closest(".parallax-elem").length > 0) {
                    var parallaxWidth = $(this).closest(".parallax-elem").width()
                        ...
                        ,$media = $(this).find(".mejs-mediaelement video, .mejs-mediaelement object, .mejs-mediaelement embed, .mejs-mediaelement iframe")
                    ...
                    if (stGlobals.isSafari && (parallaxWidth - videoWidth) / 2 < 10) {
...
(function($) {
    $(window).load(function() {
        ...
        $(".section.bookmark").sticky({ topSpacing: 54 });
    });
})(sjq);
