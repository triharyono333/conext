/*
 * Title:   Conext | Connecting Your Future - jQuery plugins
 ...
 * 3. jQuery CounTo plugin
 * 4. Isotope PACKAGED v2.0.1
 * 5. jQuery FitVids 1.0.3
 * 6. jquery.customSelect() - v0.5.1
 * 7. equal height plugin
 * 8. image loaded plugin
 * 9. jQuery easyZoom plugin
 * 10. remove with class prefix
 */
    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            function animate(current) {
                ...
                if (customSettingsObj.border == 'outline' || customSettingsObj.border == 'inline') {
...
(function($) {
    $.fn.soapPortfolioFilter = function(options)
    {
        ...
        {
            var _container       = $(this),
                _parentContainer = _container.parents('.post-wrapper'),
                _filter          = _parentContainer.find('.post-filters'),
            ...
            if (_container.hasClass("style-masonry")) {
                _options.layoutMode = 'masonry';
                _options.masonry = { columnWidth: 1 };
            }
            function runIsotope()
            {   
            ...
            _links.bind('click',function()
            {
                var current     = $(this),
                    ...
                    if (_filter.children(".filter-title").length > 0) {
                        if (typeof current.attr("title") != "undefined" ) {
                            _filter.children(".filter-title").text(current.attr("title"));
                        } else {
                            _filter.children(".filter-title").text(current.text());
                        }
                    }
...
/* 10. remove with class prefix ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
sjq.fn.removeClassPrefix = function(prefix) {
