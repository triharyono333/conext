...
<div class="content">
	<div>
      ...
      <form action="<?php print $base_url ?>/admin/contact" method="get" accept-charset="UTF-8">
				<div>
      ...
      <table class="views-table cols-3">
          ...
          <tr class="odd views-row-first">
						<td class="views-field views-field-title"><?php print $contact->name ?></td>
						<td class="views-field views-field-title"><?php print $contact->email ?></td>
						<td class="views-field views-field-edit-node">
							<a href="<?php print $base_url ?>/admin/contact/detail/<?php print $contact->id ?>">View</a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
		...
		<div style="text-align: center;">
			<?php 
			$paging_url = (empty($_GET['keyword'])) ? $base_url.'/admin/contact?' : $base_url.'/admin/contact?keyword='.$_GET['keyword'].'&';
