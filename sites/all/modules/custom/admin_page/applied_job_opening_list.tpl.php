...
<div class="content">
	<div>
      ...
      <form action="<?php print $base_url ?>/admin/applied_job_opening" method="get" accept-charset="UTF-8">
				<div>
      ...
      <table class="views-table cols-3">
				<thead>
					<tr>
						...
						<th scope="col">Opening Job</th>
						<th scope="col"></th>
					</tr>
				</thead>
				<tbody>
					<?php foreach($content['contacts'] as $contact) { ?>
          <tr class="odd views-row-first">
						<td class="views-field views-field-title"><?php print $contact->title ?></td>
						<td class="views-field views-field-title"><?php print $contact->field_job_applied_value ?></td>
						<td class="views-field views-field-edit-node">
							<a href="<?php print $base_url ?>/admin/applied_job_opening/detail/<?php print $contact->nid ?>">View</a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
		...
		<div style="text-align: center;">
			<?php 
			$paging_url = (empty($_GET['keyword'])) ? $base_url.'/admin/applied_job_opening?' : $base_url.'/admin/applied_job_opening?keyword='.$_GET['keyword'].'&';
